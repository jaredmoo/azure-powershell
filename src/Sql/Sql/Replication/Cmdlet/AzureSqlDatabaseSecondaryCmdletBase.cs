...
{
    public abstract class AzureSqlDatabaseSecondaryCmdletBase : AzureSqlCmdletResourceGroupBase<IEnumerable<AzureReplicationLinkModel>, AzureSqlDatabaseReplicationAdapter>
    {
        /// <summary>
